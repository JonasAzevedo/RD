...
uses
  ...
  IBSQL, IBDatabase, IBDatabaseInfo;
...
uses frmLoginU, IBIntf, frmUserInformationU, typInfo, frmAddCertificateU,
  frmVerboseU;
...
begin
  try
    ...
    lblCertificate.Caption := 'Cannot get licensing info for current server';
  end;
end;
