...
{*******************************************************}
{                                                       }
{       Kylix Visual Component Library                  }
{       ClientDataSet Standard Reconcile Error Dialog   }
{                                                       }
{       Copyright (c) 1998-2002 Borland International        }
{                                                       }
{*******************************************************}
...
uses
  SysUtils, {$IFDEF LINUX}Libc, {$ENDIF}Variants, Classes, QGraphics, QControls, QForms,
  QDialogs, QStdCtrls, QGrids, DB, DBClient, Provider, QExtCtrls;
