...
uses
  ...
  IWCompButton, IWControl, IWCompText, MenuFrame;
...
type
  TformEditGrid = class(TIWAppForm)
    ...
    procedure tablGridRenderCell(ACell: TIWGridCell; const ARow,
      AColumn: Integer);
    procedure tablGridCellClick(const ARow, AColumn: Integer);
  protected
    procedure Total;
...
procedure TformEditGrid.tablGridCellClick(const ARow, AColumn: Integer);
var
  LButton: TIWButton;
  LEdit: TIWEdit;
begin
