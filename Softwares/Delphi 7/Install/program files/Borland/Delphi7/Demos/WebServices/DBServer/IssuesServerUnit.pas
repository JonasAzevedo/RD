...
type
  ...
  IIssues = interface(IInvokable)
   ['{CC530C3C-2854-11D5-BF78-00C04F79AB6E}']
    function AddTwo(A, B: Integer): Integer; stdcall;
  ...
  IIssueDataSet = interface(IInvokable)
  ['{928617FD-3436-11D5-BF7B-00C04F79AB6E}']
  end;
...
function TIssues.AddTwo(A, B: Integer): Integer; stdcall;
  begin
    Result := A+B;
  end;
...
Initialization
//  InvRegistry.RegisterInvokableClass(TIssue);
  InvRegistry.RegisterInterface(TypeInfo(IIssues));
  InvRegistry.RegisterInvokableClass(TIssues);
(*  InvRegistry.RegisterInterface(TypeInfo(IIssueDataSet));
  InvRegistry.RegisterInvokableClass(TIssueDataSet); *)
  RemClassRegistry.RegisterXSClass(TIssue, '', 'TIssue', False);
  RemClassRegistry.RegisterXSClass(TIssueError, '', 'TIssueError', False);
  RemClassRegistry.RegisterXSInfo(TypeInfo(TIssueArray), '', 'TIssueArray', False);
  RemClassRegistry.RegisterXSInfo(TypeInfo(TErrorArray), '', 'TErrorArray', False);
  RemClassRegistry.RegisterXSInfo(TypeInfo(TIssueUpdateType), '', 'TIssueUpdateType', False);
//  InvRegistry.RegisterInvokableClass(TDataSet);
