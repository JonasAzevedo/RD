...
// PASTLWTR : 1.2
// File generated on 6/19/2002 4:58:23 PM from Type Library described below.

// ************************************************************************  //
// Type Lib: h:\typelib\typelib\typelibraries\OfficeXP\msppt.olb (1)
// LIBID: {91493440-5A91-11CF-8700-00AA0060263B}
// LCID: 0
// Helpfile: h:\typelib\typelib\typelibraries\OfficeXP\VBAPP10.CHM
...
uses Windows, ActiveX, Classes, Graphics, OfficeXP, OleServer, StdVCL, Variants, 
VBIDEXP;
...
{$ENDIF}
  ...
  protected
    ...
    procedure Set_Design(const Design: Design);
...
{$ENDIF}
  ...
  protected
    ...
    function Get_SnapToGrid: MsoTriState;
    procedure Set_SnapToGrid(SnapToGrid: MsoTriState);
    function Get_GridDistance: Single;
    procedure Set_GridDistance(GridDistance: Single);
    function Get_Designs: Designs;
    function Get_Signatures: SignatureSet;
    function Get_RemovePersonalInformation: MsoTriState;
    procedure Set_RemovePersonalInformation(RemovePersonalInformation: MsoTriState);
    function Get_HasRevisionInfo: PpRevisionInfo;
    function Get_PasswordEncryptionProvider: WideString;
    function Get_PasswordEncryptionAlgorithm: WideString;
    function Get_PasswordEncryptionKeyLength: SYSINT;
    function Get_PasswordEncryptionFileProperties: WordBool;
    function Get_Password: WideString;
    procedure Set_Password(const Password: WideString);
    function Get_WritePassword: WideString;
    procedure Set_WritePassword(const WritePassword: WideString);
  public
    constructor Create(AOwner: TComponent); override;
    destructor  Destroy; override;
    procedure Connect; override;
    ...
    procedure Merge(const Path: WideString);
    procedure CheckIn(SaveChanges: WordBool); overload;
    procedure CheckIn(SaveChanges: WordBool; Comments: OleVariant); overload;
    procedure CheckIn(SaveChanges: WordBool; Comments: OleVariant; MakePublic: OleVariant); overload;
    function CanCheckIn: WordBool;
    procedure SendForReview(const Recipients: WideString; const Subject: WideString; 
                            ShowMessage: WordBool); overload;
    procedure SendForReview(const Recipients: WideString; const Subject: WideString; 
                            ShowMessage: WordBool; IncludeAttachment: OleVariant); overload;
    procedure ReplyWithChanges(ShowMessage: WordBool);
    procedure EndReview;
    procedure AddBaseline(const FileName: WideString);
    procedure RemoveBaseline;
    procedure SetPasswordEncryptionOptions(const PasswordEncryptionProvider: WideString; 
                                           const PasswordEncryptionAlgorithm: WideString; 
                                           PasswordEncryptionKeyLength: SYSINT; 
                                           PasswordEncryptionFileProperties: WordBool);
...
// *********************************************************************//
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  TPowerRexProperties= class;
{$ENDIF}
  TPowerRex = class(TOleServer)
  private
    FIntf:        _PowerRex;
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    FProps:       TPowerRexProperties;
    function      GetServerProperties: TPowerRexProperties;
{$ENDIF}
    function      GetDefaultInterface: _PowerRex;
  protected
    procedure InitServerData; override;
  public
    constructor Create(AOwner: TComponent); override;
    destructor  Destroy; override;
    procedure Connect; override;
    procedure ConnectTo(svrIntf: _PowerRex);
    procedure Disconnect; override;
    procedure OnAsfEncoderEvent(erorCode: OleVariant; bstrErrorDesc: OleVariant);
    property DefaultInterface: _PowerRex read GetDefaultInterface;
  published
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
    property Server: TPowerRexProperties read GetServerProperties;
{$ENDIF}
  end;
...
//  of the properties of this server)
// *********************************************************************//
 TPowerRexProperties = class(TPersistent)
  private
    FServer:    TPowerRex;
    function    GetDefaultInterface: _PowerRex;
    constructor Create(AServer: TPowerRex);
  protected
  public
    property DefaultInterface: _PowerRex read GetDefaultInterface;
  published
...
function TPowerPointGlobal.Get_Dialogs: IUnknown;
begin
...
function TPowerPointGlobalProperties.Get_Dialogs: IUnknown;
begin
    Result := DefaultInterface.Dialogs;
end;
...
function TPowerPointSlide.Get_Comments: Comments;
begin
    Result := DefaultInterface.Comments;
end;

function TPowerPointSlide.Get_Design: Design;
begin
    Result := DefaultInterface.Design;
end;

procedure TPowerPointSlide.Set_Design(const Design: Design);
begin
  DefaultInterface.Set_Design(Design);
end;

function TPowerPointSlide.Get_TimeLine: TimeLine;
begin
    Result := DefaultInterface.TimeLine;
end;
...
procedure TPowerPointSlide.MoveTo(toPos: SYSINT);
begin
  DefaultInterface.MoveTo(toPos);
end;

procedure TPowerPointSlide.ApplyTemplate(const FileName: WideString);
begin
...
function TPowerPointSlideProperties.Get_Comments: Comments;
begin
    Result := DefaultInterface.Comments;
end;

function TPowerPointSlideProperties.Get_Design: Design;
begin
    Result := DefaultInterface.Design;
end;

procedure TPowerPointSlideProperties.Set_Design(const Design: Design);
begin
  DefaultInterface.Set_Design(Design);
end;

function TPowerPointSlideProperties.Get_TimeLine: TimeLine;
begin
    Result := DefaultInterface.TimeLine;
end;
...
function TPowerPointPresentation.Get_SnapToGrid: MsoTriState;
begin
    Result := DefaultInterface.SnapToGrid;
end;

procedure TPowerPointPresentation.Set_SnapToGrid(SnapToGrid: MsoTriState);
begin
  DefaultInterface.Set_SnapToGrid(SnapToGrid);
end;

function TPowerPointPresentation.Get_GridDistance: Single;
begin
    Result := DefaultInterface.GridDistance;
end;

procedure TPowerPointPresentation.Set_GridDistance(GridDistance: Single);
begin
  DefaultInterface.Set_GridDistance(GridDistance);
end;

function TPowerPointPresentation.Get_Designs: Designs;
begin
    Result := DefaultInterface.Designs;
end;

function TPowerPointPresentation.Get_Signatures: SignatureSet;
begin
    Result := DefaultInterface.Signatures;
end;

function TPowerPointPresentation.Get_RemovePersonalInformation: MsoTriState;
begin
    Result := DefaultInterface.RemovePersonalInformation;
end;

procedure TPowerPointPresentation.Set_RemovePersonalInformation(RemovePersonalInformation: MsoTriState);
begin
  DefaultInterface.Set_RemovePersonalInformation(RemovePersonalInformation);
end;

function TPowerPointPresentation.Get_HasRevisionInfo: PpRevisionInfo;
begin
    Result := DefaultInterface.HasRevisionInfo;
end;

function TPowerPointPresentation.Get_PasswordEncryptionProvider: WideString;
begin
    Result := DefaultInterface.PasswordEncryptionProvider;
end;

function TPowerPointPresentation.Get_PasswordEncryptionAlgorithm: WideString;
begin
    Result := DefaultInterface.PasswordEncryptionAlgorithm;
end;

function TPowerPointPresentation.Get_PasswordEncryptionKeyLength: SYSINT;
begin
    Result := DefaultInterface.PasswordEncryptionKeyLength;
end;

function TPowerPointPresentation.Get_PasswordEncryptionFileProperties: WordBool;
begin
    Result := DefaultInterface.PasswordEncryptionFileProperties;
end;

function TPowerPointPresentation.Get_Password: WideString;
begin
    Result := DefaultInterface.Password;
end;

procedure TPowerPointPresentation.Set_Password(const Password: WideString);
...
begin
  InterfaceVariant := DefaultInterface;
  InterfaceVariant.Password := Password;
end;

function TPowerPointPresentation.Get_WritePassword: WideString;
begin
    Result := DefaultInterface.WritePassword;
end;

procedure TPowerPointPresentation.Set_WritePassword(const WritePassword: WideString);
  { Warning: The property WritePassword has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
  InterfaceVariant: OleVariant;
begin
  InterfaceVariant := DefaultInterface;
  InterfaceVariant.WritePassword := WritePassword;
end;
...
procedure TPowerPointPresentation.Merge(const Path: WideString);
begin
  DefaultInterface.Merge(Path);
end;

procedure TPowerPointPresentation.CheckIn(SaveChanges: WordBool);
begin
  DefaultInterface.CheckIn(SaveChanges, EmptyParam, EmptyParam);
end;

procedure TPowerPointPresentation.CheckIn(SaveChanges: WordBool; Comments: OleVariant);
begin
  DefaultInterface.CheckIn(SaveChanges, Comments, EmptyParam);
end;

procedure TPowerPointPresentation.CheckIn(SaveChanges: WordBool; Comments: OleVariant; 
                                          MakePublic: OleVariant);
begin
  DefaultInterface.CheckIn(SaveChanges, Comments, MakePublic);
end;

function TPowerPointPresentation.CanCheckIn: WordBool;
begin
  Result := DefaultInterface.CanCheckIn;
end;

procedure TPowerPointPresentation.SendForReview(const Recipients: WideString; 
                                                const Subject: WideString; ShowMessage: WordBool);
begin
  DefaultInterface.SendForReview(Recipients, Subject, ShowMessage, EmptyParam);
end;

procedure TPowerPointPresentation.SendForReview(const Recipients: WideString; 
                                                const Subject: WideString; ShowMessage: WordBool; 
                                                IncludeAttachment: OleVariant);
begin
  DefaultInterface.SendForReview(Recipients, Subject, ShowMessage, IncludeAttachment);
end;

procedure TPowerPointPresentation.ReplyWithChanges(ShowMessage: WordBool);
begin
  DefaultInterface.ReplyWithChanges(ShowMessage);
end;

procedure TPowerPointPresentation.EndReview;
begin
  DefaultInterface.EndReview;
end;

procedure TPowerPointPresentation.AddBaseline(const FileName: WideString);
begin
  DefaultInterface.AddBaseline(FileName);
end;

procedure TPowerPointPresentation.RemoveBaseline;
begin
  DefaultInterface.RemoveBaseline;
end;

procedure TPowerPointPresentation.SetPasswordEncryptionOptions(const PasswordEncryptionProvider: WideString; 
                                                               const PasswordEncryptionAlgorithm: WideString; 
                                                               PasswordEncryptionKeyLength: SYSINT; 
                                                               PasswordEncryptionFileProperties: WordBool);
begin
  DefaultInterface.SetPasswordEncryptionOptions(PasswordEncryptionProvider, 
...
function TPowerPointPresentationProperties.Get_SnapToGrid: MsoTriState;
begin
    Result := DefaultInterface.SnapToGrid;
end;

procedure TPowerPointPresentationProperties.Set_SnapToGrid(SnapToGrid: MsoTriState);
begin
  DefaultInterface.Set_SnapToGrid(SnapToGrid);
end;

function TPowerPointPresentationProperties.Get_GridDistance: Single;
begin
    Result := DefaultInterface.GridDistance;
end;

procedure TPowerPointPresentationProperties.Set_GridDistance(GridDistance: Single);
begin
  DefaultInterface.Set_GridDistance(GridDistance);
end;

function TPowerPointPresentationProperties.Get_Designs: Designs;
begin
    Result := DefaultInterface.Designs;
end;

function TPowerPointPresentationProperties.Get_Signatures: SignatureSet;
begin
    Result := DefaultInterface.Signatures;
end;

function TPowerPointPresentationProperties.Get_RemovePersonalInformation: MsoTriState;
begin
    Result := DefaultInterface.RemovePersonalInformation;
end;

procedure TPowerPointPresentationProperties.Set_RemovePersonalInformation(RemovePersonalInformation: MsoTriState);
begin
  DefaultInterface.Set_RemovePersonalInformation(RemovePersonalInformation);
end;

function TPowerPointPresentationProperties.Get_HasRevisionInfo: PpRevisionInfo;
begin
    Result := DefaultInterface.HasRevisionInfo;
end;

function TPowerPointPresentationProperties.Get_PasswordEncryptionProvider: WideString;
begin
    Result := DefaultInterface.PasswordEncryptionProvider;
end;

function TPowerPointPresentationProperties.Get_PasswordEncryptionAlgorithm: WideString;
begin
    Result := DefaultInterface.PasswordEncryptionAlgorithm;
end;

function TPowerPointPresentationProperties.Get_PasswordEncryptionKeyLength: SYSINT;
begin
    Result := DefaultInterface.PasswordEncryptionKeyLength;
end;

function TPowerPointPresentationProperties.Get_PasswordEncryptionFileProperties: WordBool;
begin
    Result := DefaultInterface.PasswordEncryptionFileProperties;
end;

function TPowerPointPresentationProperties.Get_Password: WideString;
begin
    Result := DefaultInterface.Password;
end;

procedure TPowerPointPresentationProperties.Set_Password(const Password: WideString);
  { Warning: The property Password has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TPowerPointPresentationProperties.Get_WritePassword: WideString;
begin
    Result := DefaultInterface.WritePassword;
end;

procedure TPowerPointPresentationProperties.Set_WritePassword(const WritePassword: WideString);
  { Warning: The property WritePassword has a setter and a getter whose
    types do not match. Delphi was unable to generate a property of
    this sort and so is using a Variant as a passthrough. }
var
...
function TMaster.Get_Design: Design;
begin
    Result := DefaultInterface.Design;
end;

function TMaster.Get_TimeLine: TimeLine;
begin
    Result := DefaultInterface.TimeLine;
end;

function TMaster.Get_SlideShowTransition: SlideShowTransition;
begin
    Result := DefaultInterface.SlideShowTransition;
end;
...
function TMasterProperties.Get_Design: Design;
begin
    Result := DefaultInterface.Design;
end;

function TMasterProperties.Get_TimeLine: TimeLine;
begin
    Result := DefaultInterface.TimeLine;
end;

function TMasterProperties.Get_SlideShowTransition: SlideShowTransition;
begin
    Result := DefaultInterface.SlideShowTransition;
end;
...
procedure TPowerRex.InitServerData;
const
  CServerData: TServerData = (
    ClassID:   '{91493448-5A91-11CF-8700-00AA0060263B}';
    IntfIID:   '{914934D3-5A91-11CF-8700-00AA0060263B}';
    EventIID:  '';
    LicenseKey: nil;
    Version: 500);
begin
...
begin
  ...
  begin
    punk := GetServer;
    Fintf:= punk as _PowerRex;
  end;
end;

procedure TPowerRex.ConnectTo(svrIntf: _PowerRex);
begin
  Disconnect;
  FIntf := svrIntf;
end;

procedure TPowerRex.DisConnect;
begin
  if Fintf <> nil then
  begin
    FIntf := nil;
...
function TPowerRex.GetDefaultInterface: _PowerRex;
begin
  if FIntf = nil then
    Connect;
  Assert(FIntf <> nil, 'DefaultInterface is NULL. Component is not connected to Server. You must call ''Connect'' or ''ConnectTo'' before this operation');
...
constructor TPowerRex.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps := TPowerRexProperties.Create(Self);
{$ENDIF}
end;

destructor TPowerRex.Destroy;
begin
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
  FProps.Free;
{$ENDIF}
...
{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
function TPowerRex.GetServerProperties: TPowerRexProperties;
begin
  Result := FProps;
end;
{$ENDIF}

procedure TPowerRex.OnAsfEncoderEvent(erorCode: OleVariant; bstrErrorDesc: OleVariant);
begin
  DefaultInterface.OnAsfEncoderEvent(erorCode, bstrErrorDesc);
end;

{$IFDEF LIVE_SERVER_AT_DESIGN_TIME}
constructor TPowerRexProperties.Create(AServer: TPowerRex);
begin
  inherited Create;
  FServer := AServer;
end;

function TPowerRexProperties.GetDefaultInterface: _PowerRex;
begin
  Result := FServer.DefaultInterface;
end;
