...
// PASTLWTR : 1.2
// File generated on 6/19/2002 1:30:39 PM from Type Library described below.

// ************************************************************************  //
// Type Lib: w:\Typelib\typelib\typelibraries\msppt8.olb (1)
// LIBID: {91493440-5A91-11CF-8700-00AA0060263B}
// LCID: 0
// Helpfile: C:\Program Files\Microsoft Office\Office\VBAPPT8.HLP
...
uses Windows, ActiveX, Classes, Graphics, Office97, OleServer, StdVCL, Variants, 
VBIDE97;
...
// *********************************************************************//
  _GlobalDisp = dispinterface
    ...
    property Application: IDispatch readonly dispid 2004;
...
// *********************************************************************//
  PrintRangesDisp = dispinterface
    ...
    property Application: IDispatch readonly dispid 2002;
...
// *********************************************************************//
  PPControlDisp = dispinterface
    ['{914934A4-5A91-11CF-8700-00AA0060263B}']
    property Application: IDispatch readonly dispid 1001;
...
{$ENDIF}
  ...
  protected
    ...
    function Get_Application: IDispatch;
    function Get_Parent: IDispatch;
    function Get_SlideMaster: Master;
    function Get_TitleMaster: Master;
    function Get_HasTitleMaster: MsoTriState;
    function Get_TemplateName: WideString;
    function Get_NotesMaster: Master;
    function Get_HandoutMaster: Master;
  ...
  public
    ...
    procedure Disconnect; override;
    function AddTitleMaster: Master;
...
function TPowerPointGlobal.Get_Application: IDispatch;
begin
...
function TPowerPointGlobalProperties.Get_Application: IDispatch;
begin
    Result := DefaultInterface.Application;
end;
...
function TPowerPointSlide.Get_Application: IDispatch;
begin
    Result := DefaultInterface.Application;
end;
...
function TPowerPointSlide.Get_Master: Master;
begin
...
function TPowerPointSlideProperties.Get_Application: IDispatch;
begin
    Result := DefaultInterface.Application;
end;
...
function TPowerPointSlideProperties.Get_Master: Master;
begin
    Result := DefaultInterface.Master;
end;
...
function TPowerPointPresentation.Get_Application: IDispatch;
begin
    Result := DefaultInterface.Application;
end;
...
function TPowerPointPresentation.Get_SlideMaster: Master;
begin
    Result := DefaultInterface.SlideMaster;
end;

function TPowerPointPresentation.Get_TitleMaster: Master;
begin
...
function TPowerPointPresentation.Get_NotesMaster: Master;
begin
    Result := DefaultInterface.NotesMaster;
end;

function TPowerPointPresentation.Get_HandoutMaster: Master;
begin
...
function TPowerPointPresentation.AddTitleMaster: Master;
begin
...
function TPowerPointPresentationProperties.Get_Application: IDispatch;
begin
    Result := DefaultInterface.Application;
end;
...
function TPowerPointPresentationProperties.Get_SlideMaster: Master;
begin
    Result := DefaultInterface.SlideMaster;
end;

function TPowerPointPresentationProperties.Get_TitleMaster: Master;
begin
    Result := DefaultInterface.TitleMaster;
end;
...
function TPowerPointPresentationProperties.Get_NotesMaster: Master;
begin
    Result := DefaultInterface.NotesMaster;
end;

function TPowerPointPresentationProperties.Get_HandoutMaster: Master;
begin
    Result := DefaultInterface.HandoutMaster;
end;
