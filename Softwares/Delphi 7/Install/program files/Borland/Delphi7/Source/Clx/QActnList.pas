...
uses RTLConsts, QForms, QMenus, QConsts, QGraphics, QControls;
...
var
  Event: QCustomEventH;
begin
  Event := QCustomEvent_create(QEventType_CMActionUpdate, Self);
  try
