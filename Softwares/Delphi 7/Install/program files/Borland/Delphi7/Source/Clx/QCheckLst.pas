...
type
  ...
  protected
    ...
    procedure InternalSetItemData(Index: Integer; Data: Longint); override;
...
procedure TCheckListBox.MeasureItem(Control: TWinControl; item: QClxListBoxItemH;
  var Height, Width: Integer);
begin
  Width := Width + GetCheckWidth;
  inherited MeasureItem(Control, item, Height, Width);
end;
...
procedure TCheckListBox.InternalSetItemData(Index, Data: Integer);
begin
  inherited SetItemData(Index, Data);
end;
